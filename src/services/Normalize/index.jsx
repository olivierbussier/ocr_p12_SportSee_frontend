export class Normalize {
  ...
  dataUser = (data) => {
    ...
    */
    ...
    // score ou todayScore
    const todayScoreOk =
      typeof data.todayScore === "number" || typeof data.score === "number"
        ? true
        : false;
  ...
  */
    ...
    const sessionsOk =
      typeof data.sessions === "object" && data.sessions.length > 0
        ? true
        : false;
  ...
  dataDuree = (data) => {
    ...
    */
    ...
    const sessionsEachOk = data.sessions.reduce((accu, current) => {
      return (
        accu &&
        typeof current.day === "number" &&
        typeof current.sessionLength === "number"
      );
    }, true);
  ...
  dataPerformance = (data) => {
    ...
    */
    ...
    const kindOk =
      typeof data.kind === "object" && Object.keys(data.kind).length > 0
        ? true
        : false;
